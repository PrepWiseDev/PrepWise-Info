 ...
 *
 * The text is the CONFIRMED-facts section of references/author.md and nothing
 * else. The draft bios in that file are still marked TODO(trent: confirm), and
 * an author bio is the single worst place on a site to publish an unapproved
 * sentence: E-E-A-T is exactly where an invented credential is the signal
  ...
  return (
    <aside className="rounded-2xl border border-pw-border-soft bg-pw-bg-card/60 p-6">
      ...
      <p className="text-pw-text-subtle text-sm leading-relaxed">
        Founder of PrepWise LLC. He built PrepWise, an iPhone meal planner and
        pantry tracker, and shipped it to the App Store in June 2026.
      </p>
    </aside>
  );
}
